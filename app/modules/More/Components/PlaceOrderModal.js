  ...
  const setPlaceOrderValues = () => {
    if (finish && rho && stamp && screw && path) {
      ...
      if (Platform.OS === "android") {
        ...
        AlertIOS.alert("please fill all the fields");
      }
    }
  };
        ...
        >
          ...
          >
            <View style={{ marginTop: vsc(15) }}>
              <Text style={{ fontWeight: "bold", fontSize: vsc(14) }}>Finishing :</Text>
            </View>
            <View
              style={{
                marginTop: vsc(5),
            ...
            <View style={{ marginTop: vsc(5) }}>
              <Text style={{ fontWeight: "bold", fontSize: vsc(14) }}>Rhodium :</Text>
            </View>
            <View
              style={{
                marginTop: vsc(5),
            ...
            <View>
              <View>
                <Text style={{ fontWeight: "bold", fontSize: vsc(14) }}>Select Stamp :</Text>
              </View>
              <RadioButton.Group
              ...
              >
                <View style={{ flexDirection: "row" }}>
                  ...
                  >
                    <Text style={{fontSize: vsc(14), color: '#000000'}}>750</Text>
                  ...
                  >
                    <Text style={{fontSize: vsc(14), color: '#000000'}}>916</Text>
            ...
            <View>
              <View>
                <Text style={{ fontWeight: "bold", fontSize: vsc(14), color: '#000' }}>Select Screw :</Text>
              </View>
              <RadioButton.Group
              ...
              >
                <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
                  ...
                  >
                    <Text style={{ fontWeight: "bold", fontSize: vsc(14), color: '#000' }}>North Screw</Text>
                  ...
                  >
                    <Text style={{ fontWeight: "bold", fontSize: vsc(14), color: '#000' }}>South Screw</Text>
            ...
            <View>
              <View>
                <Text style={{ fontWeight: "bold", fontSize: vsc(14), color: '#000' }}>
              ...
              >
                <View style={{}}>
                  ...
                  >
                    <Text style={{  fontSize: vsc(14), color: '#000' }}>With Patch</Text>
                  ...
                  >
                    <Text style={{  fontSize: vsc(14), color: '#000' }}>With Out Patch</Text>
